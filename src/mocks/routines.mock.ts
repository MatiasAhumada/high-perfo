...
export const routinesMock: RoutineTemplateMock[] = [
  {
    ...
    description:
      "Protocolo de fuerza máxima basado en el sistema búlgaro con cargas elevadas y volumen reducido",
    exercises: [
      {
        id: "ex-001",
  ...
  },
  {
    ...
    description:
      "Rutina de potencia basada en Velocity Based Training con rangos de velocidad óptimos",
    exercises: [
      {
        id: "ex-005",
        exerciseName: "Sentadilla con Salto",
        sets: 4,
        reps: 5,
        percent1RM: 55,
        advancedSettings: false,
      ...
      {
        id: "ex-006",
        exerciseName: "Press Banco con Pause",
        sets: 3,
        reps: 3,
        percent1RM: 70,
        advancedSettings: true,
  ...
  },
  {
    ...
    description:
      "Protocolo de recuperación activa con ejercicios de baja intensidad y movilidad",
    exercises: [
      {
        id: "ex-008",
      ...
      {
        id: "ex-009",
        exerciseName: "Hip Thrust con Banda",
        sets: 3,
        reps: 12,
        percent1RM: 40,
        advancedSettings: false,

...
export async function GET(
  ...
  try {
    ...
    const assessment = await assessmentService.findById(id, user.accountId, user)
...
export async function PATCH(
  ...
  try {
    ...
    const updated = await assessmentService.update(id, parsed.data, user.accountId, user)

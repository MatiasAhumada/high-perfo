...
export async function GET(
  ...
  try {
    ...
    const tools = await toolService.findByRoutine(routineId, user.accountId, user)
...
export async function POST(
  ...
  try {
    ...
    const tool = await toolService.create(routineId, parsed.data, user.accountId, user)

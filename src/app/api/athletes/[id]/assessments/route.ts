...
export async function GET(
  ...
  try {
    ...
    const result = await assessmentService.findByAthlete(athleteId, accountId, user, { page, pageSize })
...
export async function POST(
  ...
  try {
    ...
    const assessment = await assessmentService.create(athleteId, parsed.data, user.id, accountId, user)

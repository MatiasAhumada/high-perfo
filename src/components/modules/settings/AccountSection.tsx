...
export function AccountSection({ delay = 0 }: AccountSectionProps) {
  return (
    ...
    >
      ...
      <div>
        <label className="text-label-caps text-on-surface-variant/50 block mb-1">Organización</label>
        <input className={INPUT_CLASSES} placeholder="FinanciaTech" defaultValue="FinanciaTech" />
      </div>
      <div>
        <label className="text-label-caps text-on-surface-variant/50 block mb-1">Rol</label>

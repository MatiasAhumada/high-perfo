  ...
  return (
    ...
    >
      <h3 className="font-display font-semibold text-on-surface">
        {UI_TEXTS.SETTINGS.VISUAL_CONFIG}
      </h3>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        <div>
          <label className="text-[10px] sm:text-xs text-on-surface-variant/50 block mb-2">
            {UI_TEXTS.SETTINGS.PRIMARY_COLOR}
          </label>
          <div className="flex items-center gap-3">
            ...
            />
            <span className="text-xs sm:text-sm font-body text-on-surface-variant/60">
              {primaryColor}
            </span>
          </div>
        </div>
        <div>
          <label className="text-[10px] sm:text-xs text-on-surface-variant/50 block mb-2">
            {UI_TEXTS.SETTINGS.SURFACE_COLOR}
          </label>
          <div className="flex items-center gap-3">
            <input
              type="color"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div>
          <label className="text-[10px] sm:text-xs text-on-surface-variant/50 block mb-2">
            {UI_TEXTS.SETTINGS.BORDER_RADIUS}
          </label>
          <input
            type="range"
            min="0"
      ...
      <div className="pt-2">
        ...
        >
          ...
          <p style={{ color: textColor }} className="text-sm">
            Texto de ejemplo con la configuración seleccionada
          </p>

  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        <div>
          <label className="text-[10px] sm:text-xs text-on-surface-variant/50 block mb-1">Nombre</label>
          <input className={INPUT_CLASSES} placeholder="Alejandro" defaultValue="Alejandro" />
        </div>
        <div>
          <label className="text-[10px] sm:text-xs text-on-surface-variant/50 block mb-1">Apellido</label>
          <input className={INPUT_CLASSES} placeholder="Gutiérrez" defaultValue="Gutiérrez" />
        </div>
      </div>
      <div>
        <label className="text-[10px] sm:text-xs text-on-surface-variant/50 block mb-1">Email</label>

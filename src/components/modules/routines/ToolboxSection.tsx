            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="font-display text-sm text-on-surface font-medium truncate">
                    {tool.name}
                  </p>
                  <p className="text-xs text-on-surface-variant/40 mt-0.5 hidden sm:block">
                    {tool.description}
                  </p>
                </div>
              </div>
              ...
              >
                {isSelected
                  ? UI_TEXTS.TOOLS.ACTIVATED
                  : UI_TEXTS.TOOLS.DEACTIVATED}
              </span>
            </label>
          );
        })}

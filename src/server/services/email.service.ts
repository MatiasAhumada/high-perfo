...
export const emailService = {
  async sendRoutineEmail(routineId: string, recipientEmails: string[], accountId: string): Promise<void> {
    const routine = await assignedRoutineRepository.findByIdWithTemplate(routineId)

...
export const athleteService = {
  async findAll(accountId: string, user: SessionUser, options: AthleteFindOptions) {
  ...
  async update(id: string, dto: Record<string, unknown>, accountId: string, user: SessionUser) {
    requireAccountAccess(user, accountId)

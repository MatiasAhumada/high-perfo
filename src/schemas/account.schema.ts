...
export const createAccountWithUserSchema = z.object({
  ...
  userName: z.string().min(2, UI_TEXTS.FORM_ERRORS.MIN_LENGTH.replace("{min}", "2")),
  userPassword: z.string().min(8, UI_TEXTS.FORM_ERRORS.MIN_LENGTH.replace("{min}", "8")),
...
export type CreateAccountWithUserInput = z.infer<typeof createAccountWithUserSchema>;
export type CreateAccountWithPlanInput = z.infer<typeof createAccountWithPlanSchema>;